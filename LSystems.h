...
namespace octet {
  ...
  private:
    ...
    // L system trees
    L_system tree_1, tree_2, tree_3, tree_4, tree_5, tree_6;
  ...
  public:
    ...
    void app_init() {
      ...
      material *red = new material(vec4(1, 0, 0.6f, 1), shader);
